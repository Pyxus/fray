...
func _enter_tree() -> void:
	...
	add_custom_type("ActionGraph", "Node", FrayCombatState.ActionGraph, preload("assets/icons/action_graph.svg"))
	add_custom_type("ActionFSM", "Resource", FrayCombatState.ActionFSM, null)
