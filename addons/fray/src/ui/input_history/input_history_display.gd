...
const DetectedInput = preload("res://addons/fray/src/input/detected_inputs/detected_input.gd")
const DetectedInputButton = preload("res://addons/fray/src/input/detected_inputs/detected_input_button.gd")
