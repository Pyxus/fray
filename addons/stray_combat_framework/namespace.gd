...
const BoxSwitcher2D = preload("combat/2d/state_management/box_switcher_2d.gd")
const HitState2D = preload("combat/2d/state_management/hit_state_2d.gd")
const HitStateController2D = preload("combat/2d/state_management/hit_state_controller_2d.gd")